...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | WpStarter's queue API supports an assortment of back-ends via a single
    | API, giving you convenient access to each back-end using the same
    | syntax for every one. Here you may define a default connection.
    |
    */

    'default' => ws_env('QUEUE_CONNECTION', 'sync'),
    ...
    | for each back-end shipped with WpStarter. You are free to add more.
    |
    ...
    */
    ...
    'failed' => [
        ...
        'database' => ws_env('DB_CONNECTION', 'mysql'),
        'table' => 'failed_jobs',
    ],
